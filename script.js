...
//! ==============================8/8/23=====================
  ...
  contains(searchVal) {
    // Check if "current" is null.
    if (this.root === null) {
        // If "current" is null, return false since there's nothing there.
        return false
    }
    //declare new current variable
  ...
  containsRecursive(searchVal, current = this.root) {
    // changed to data to become "current" for the sake of recursive
    if (current === null) {
        // If "current" is null, return null since there is no maximum value.
        console.log("Answer: ");
        return false
